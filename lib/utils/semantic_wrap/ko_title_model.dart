...
/// Level "coarse", penalty 0.
const Map<String, Map<String, int>> koreanCoarseTitleWeights =
    <String, Map<String, int>>{
      ...
      "TW4": <String, int>{" 가장": 1013, " 아무": 252},
      "TW3": <String, int>{"지 세": 164},
    };

/// Level "medium", penalty 0.35.
const Map<String, Map<String, int>> koreanMediumTitleWeights =
    <String, Map<String, int>>{
      "UW3": <String, int>{
        "다": 2302,
        "는": -609,
      ...
      "BW1": <String, int>{"고도": 845, "위해": 649, "전에": 460, "하면": 180},
      "TW3": <String, int>{"는 정": 240},
    };

/// Level "fine", penalty 0.7.
const Map<String, Map<String, int>> koreanFineTitleWeights =
    <String, Map<String, int>>{
      "UW3": <String, int>{
        "을": 1232,
        "는": -804,
      ...
      "BW1": <String, int>{"리가": -734, "위해": 429, "하는": -138},
    };
