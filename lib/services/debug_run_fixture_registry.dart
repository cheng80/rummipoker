...
/// 새 디버그 픽스처는 여기에 등록하고, 대응하는 builder는 service 파일에 둔다.
final List<DebugRunFixtureDefinition> _debugRunFixtures = [
  DebugRunFixtureDefinition(
    ...
    builder: DebugRunFixtureService._buildStage2ScoringSnapshot,
  ),
  DebugRunFixtureDefinition(
  ...
  DebugRunFixtureDefinition(
    ...
    builder: DebugRunFixtureService._buildAnimationEffectsEyeCheck,
  ),
  DebugRunFixtureDefinition(
    id: DebugRunFixtureService.itemMotionEyeCheck,
    label: '아이템 모션 눈검증 전투',
    description: 'Deck Needle / Emergency Draw / Slide Wax 발동-대상-결과 검증용',
    builder: DebugRunFixtureService._buildItemMotionEyeCheck,
  ),
  DebugRunFixtureDefinition(
