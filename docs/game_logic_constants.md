...
**근거 코드**: 주로 `lib/logic/rummi_poker_grid/`, `docs/rummi_poker_grid_game_logic.md`.  
...
- 제스터 카드 표: `data/common/jesters_common_phase5.json` ↔ 문서 `docs/jesters_common_phase5.md`
