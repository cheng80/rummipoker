...
- station/tier source split: MAE 0.0487, RMSE 0.0952, R2 0.7265.
- sequence/path source split: MAE 0.0560, RMSE 0.1055, R2 0.8482.
...
|---|---:|---:|---:|---:|---:|---|
| station/tier | 0.0487 | 0.0952 | 0.7265 | 46396 | 266 | 구간 힌트 전용 |
| sequence/path | 0.0560 | 0.1055 | 0.8482 | 3394 | 242 | 후보 선별 보조 신호 |
