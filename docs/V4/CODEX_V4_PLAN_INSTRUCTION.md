...
- `docs/V4/V4_IMPLEMENTATION_PLAN.md` 생성 또는 수정
- 필요 시 `docs/V4/V4_PLAN_RISK_REGISTER.md` 생성
- 필요 시 `docs/V4/V4_PLAN_TRACEABILITY_MATRIX.md` 생성
...
5. `docs/V4/rummi_poker_grid_design_docs_v4/00_README.md`
6. `docs/V4/rummi_poker_grid_design_docs_v4/V4_MASTER_SPEC.md`
7. `docs/V4/rummi_poker_grid_design_docs_v4/01_CURRENT_BASELINE.md`
8. `docs/V4/rummi_poker_grid_design_docs_v4/02_CORE_COMBAT_RULES.md`
9. `docs/V4/rummi_poker_grid_design_docs_v4/03_RUN_META_ECONOMY.md`
10. `docs/V4/rummi_poker_grid_design_docs_v4/04_JESTER_MARKET_CONTENT.md`
11. `docs/V4/rummi_poker_grid_design_docs_v4/05_SAVE_CHECKPOINT_DATA.md`
12. `docs/V4/rummi_poker_grid_design_docs_v4/06_UI_UX_FLOW.md`
13. `docs/V4/rummi_poker_grid_design_docs_v4/07_TECHNICAL_ARCHITECTURE.md`
14. `docs/V4/rummi_poker_grid_design_docs_v4/08_MIGRATION_ROADMAP.md`
15. `docs/V4/rummi_poker_grid_design_docs_v4/09_TEST_QA_ACCEPTANCE.md`
16. `docs/V4/rummi_poker_grid_design_docs_v4/10_TERMINOLOGY_ALIAS.md`
17. `docs/V4/rummi_poker_grid_design_docs_v4/11_OPEN_DECISIONS.md`
18. `docs/V4/rummi_poker_grid_design_docs_v4/12_CHANGELOG_FROM_V3.md`
...
`V4_IMPLEMENTATION_PLAN.md`는 아래 라벨을 사용해야 한다.
...
## 5. `V4_IMPLEMENTATION_PLAN.md` 필수 목차
...
9. `V4_IMPLEMENTATION_PLAN.md`를 작성한다.
