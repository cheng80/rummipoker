...
| catalog audit v2 price probe | Workspace pending | `tools/sim/run_balance_sim.dart` | `catalog_audit_v2` sim-only price band 추가. r120에서는 조정 후보 구매 이벤트가 없어 normalized와 결과 동일 |
