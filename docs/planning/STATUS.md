...
> 프로토타입을 V4 구조로 흡수하기 위한 기반 공사는 거의 끝났고, Balatro-style scoring feedback P0는 1차 구현됐다. 다음 구현 초점은 feedback smoke/save-restore 경계 검증, Item effect runtime의 남은 hook, station/market pacing polish다.
...
2. Save/restore 확장 점검
   - scoring feedback P0 기준 smoke와 confirm transaction save regression은 통과
   - 남은 수동/자동 점검 후보: death/continue/restart 경계, 실제 non-fixture app background/continue eye-check
