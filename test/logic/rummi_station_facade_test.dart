...
void main() {
  group('RummiStationRuntimeFacade', () {
    test('maps current blind target and score into station objective aliases', () {
    ...
    test('maps current discard, hand size, and draw pile values into resources', () {
      final session = RummiPokerGridSession(
        runSeed: 99,
        blind: RummiBlindState(
          targetScore: 300,
    ...
    test('facade is read-only and reflects later snapshots via re-creation only', () {
