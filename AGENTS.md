...
- 공모전 풀런봇의 제출 gate 범위는 도전 난이도 S1부터 S8 Boss 클리어와 S8 정산/보상/무한 도전 진입 직전 확인까지다. S8 이후 S9+ 무한 도전 장기 생존은 제출 gate가 아니라 별도 확장 검증이다. 제출 gate는 지원 locale 5개(`ko`, `en`, `ja`, `zh-CN`, `zh-TW`) 각각 fresh 세션으로 1회씩 실행해 닫는다.
