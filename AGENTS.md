...
- **상점 리롤 비용 분리**: Jester/Tile/Q-Slot/Passive/Tool/Gear 리롤은 각 offer lane별로 독립된 비용과 첫 리롤 무료 상태를 가진다. 한 lane에서 첫 무료 리롤을 사용하거나 비용이 증가해도 다른 lane의 첫 무료/비용을 소모하거나 올리지 않는다.
